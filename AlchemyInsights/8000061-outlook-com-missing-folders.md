...
V některých případech jsou chybějící složky. Pracujeme se tento problém lze vyřešit. Stále můžete najít položky uložené v chybějících složek pomocí **vyhledávání**a mohou pomoci, pokud odhlásit a znovu přihlásit. [Zde se odhlaste.](https://login.live.com/logout.srf)

...
- Postupujte podle kroků v části Scénář 1: Platnost podpisového certifikátu tokenu služby AD FS v části ["Došlo k potížím s přístupem k webu" ze služby AD FS, když se federovaný uživatel přihlásí k Microsoftu 365, Azure nebo Intune](https://support.microsoft.com/help/2713898/there-was-a-problem-accessing-the-site-error-from-ad-fs-when-a-federat).
    
- Postupujte podle pokynů v části [Jak aktualizovat nebo opravit nastavení federované domény v Microsoftu 365, Azure nebo Intune](https://support.microsoft.com/help/2647048/how-to-update-or-repair-the-settings-of-a-federated-domain-in-office-3).

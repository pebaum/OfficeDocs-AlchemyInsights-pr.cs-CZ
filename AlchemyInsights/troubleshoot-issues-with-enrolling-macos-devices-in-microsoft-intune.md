...
3. [Zjistěte, jak zapsat macOS zařízení v Microsoft Intune](https://docs.microsoft.com/en-us/intune/macos-enroll).
    
[Příručka koncového uživatele macOS zařízení v Microsoft Intune zapsat rezervaci](https://docs.microsoft.com/en-us/intune-user-help/enroll-your-device-in-intune-macos-cp)

...
---
# <a name="enable-external-sharing-in-sharepoint-online"></a>Povolení externího sdílení ve službě SharePoint Online
...
Další informace o externím sdílení (hosté) získáte na níže uvedených odkazech.
...
- [Správa přístupu hosta v sadě Office 365 skupiny](https://docs.microsoft.com/office365/admin/create-groups/manage-guest-access-in-groups?view=o365-worldwide)
...
**Obdrželi jste chybu u externího uživatele (Guest)?**

Zkontrolujte odkazy níže. 

- [Chyby sdílení OSE ve službě SharePoint nebo OneDrive](https://docs.microsoft.com/sharepoint/sharepoint-onedrive-error-message)

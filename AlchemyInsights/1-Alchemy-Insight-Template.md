...
---
# <a name="required-customer-facing-h1-h2-doesnt-work"></a>Požadováno zákazníkem čelí H1, H2 nefunguje.
Příklad textového bloku - postupujte podle následujících pokynů:

1. Soubory ve složce **AlchemyInsights** by měl mít ID pravidla a pravidlo název [portálu pro partnery Alchymie](https://alchemyportal.azurewebsites.net) v mane.

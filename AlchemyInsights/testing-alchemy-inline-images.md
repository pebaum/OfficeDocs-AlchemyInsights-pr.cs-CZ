---
title: Testování inline obrázků Alchemy
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "43759973"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="2ab93-102">Přístup na stránku Domény</span><span class="sxs-lookup"><span data-stu-id="2ab93-102">Access the Domains Page</span></span>

<span data-ttu-id="2ab93-103">Chcete-li získat přístup ke stránce domén, stačí kliknout na tuto ikonu níže:</span><span class="sxs-lookup"><span data-stu-id="2ab93-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="2ab93-104">Pak můžete přidat, upravit nebo odebrat svou doménu.</span><span class="sxs-lookup"><span data-stu-id="2ab93-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="2ab93-105">Další informace naleznete v [nejčastějších dotazech k doménám.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="2ab93-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>

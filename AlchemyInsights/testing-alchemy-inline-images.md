---
title: Testování vložených obrázků alchymie
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "44505048"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="4472e-102">Přístup ke stránce Domény</span><span class="sxs-lookup"><span data-stu-id="4472e-102">Access the Domains Page</span></span>

<span data-ttu-id="4472e-103">Chcete-li získat přístup ke stránce domén, stačí kliknout na tuto ikonu níže:</span><span class="sxs-lookup"><span data-stu-id="4472e-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="4472e-104">Potom můžete přidat, upravit nebo odebrat doménu.</span><span class="sxs-lookup"><span data-stu-id="4472e-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="4472e-105">Další informace naleznete v [nejčastějších dotazech k doménám.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="4472e-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>

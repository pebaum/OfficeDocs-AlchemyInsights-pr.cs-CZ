...
---
# <a name="access-the-domains-page"></a>Přístup ke stránce domén

Přístup na stránku domény, klepněte na tlačítko následující ikona:
...
Můžete pak přidání, úprava nebo odebrání domény.

...
---
# <a name="access-the-domains-page"></a>Přístup ke stránce Domény

Chcete-li získat přístup ke stránce domén, stačí kliknout na tuto ikonu níže:
...
Potom můžete přidat, upravit nebo odebrat doménu.
Další informace naleznete v [nejčastějších dotazech k doménám.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)

...
ms.locfileid: "36507156"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="86be8-102">Přístup ke stránce domén</span><span class="sxs-lookup"><span data-stu-id="86be8-102">Access the Domains Page</span></span>

<span data-ttu-id="86be8-103">Přístup na stránku domény, klepněte na tlačítko následující ikona:</span><span class="sxs-lookup"><span data-stu-id="86be8-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="86be8-104">Můžete pak přidání, úprava nebo odebrání domény.</span><span class="sxs-lookup"><span data-stu-id="86be8-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="86be8-105">Další informace naleznete [Nejčastější dotazy týkající se domény.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span><span class="sxs-lookup"><span data-stu-id="86be8-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>

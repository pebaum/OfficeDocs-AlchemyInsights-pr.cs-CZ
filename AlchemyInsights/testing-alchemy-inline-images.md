...
ms.locfileid: "36743122"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="57e89-102">Přístup ke stránce domény</span><span class="sxs-lookup"><span data-stu-id="57e89-102">Access the Domains Page</span></span>

<span data-ttu-id="57e89-103">Chcete-li získat přístup ke stránce domén, stačí klepnout na následující ikonu:</span><span class="sxs-lookup"><span data-stu-id="57e89-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="57e89-104">Poté můžete doménu přidat, změnit nebo odebrat.</span><span class="sxs-lookup"><span data-stu-id="57e89-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="57e89-105">Další informace získáte v [doménách Nejčastější dotazy.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="57e89-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
